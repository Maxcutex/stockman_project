...
from stock_maintain.views import (
    PriceListAPIView,
...
router.register(
    "api/v1/structuretypes", views.StructureTypeView, basename="structure_types"
)
...
router.register(
    "api/v1/stock-management", views.StockManagementView, basename="stock_management"
)
...
urlpatterns = [
    ...
    path("api/v1/marketanalysisstock", MarketAnalysisAPIView.as_view()),
    path("api/v1/recent_articles", RecentArticlesAPIView.as_view()),
]
