    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    enumchoicefield.fields.EnumChoiceField(
                        default=stock_maintain.models.QuarterType(1),
                        enum_class=stock_maintain.models.QuarterType,
                        max_length=14,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image_file",
                    models.FileField(blank=True, upload_to="images/news_image"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "offer_type",
                    enumchoicefield.fields.EnumChoiceField(
                        default=stock_maintain.models.OfferType(3),
                        enum_class=stock_maintain.models.OfferType,
                        max_length=4,
                    ),
                ),
                (
                    "quarter_type",
                    enumchoicefield.fields.EnumChoiceField(
                        default=stock_maintain.models.OfferMethod(1),
                        enum_class=stock_maintain.models.OfferMethod,
                        max_length=3,
                    ),
                ),
