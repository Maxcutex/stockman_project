...
class Dividend(models.Model):
    ...
    sec_code = models.CharField(max_length=10)
    quarter_type = EnumChoiceField(QuarterType, default=QuarterType.first_quarter)
...
class NewsImage(models.Model):
    image_choice = Choices(
        "size930x620", "size450x330", "size300x200", "size330x220", "size158x158"
    )
